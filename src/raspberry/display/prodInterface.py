...
def main():
    ...
    def show_main_screen():
        ...
        # Label for "Lazy-Tune"
        lazy_tune_label = tk.Label(window, text="Lazy-Tune", font=("Helvetica", 20))
        lazy_tune_label.grid(row=0, column=0, columnspan=4, sticky="ew")  # Span 3 columns for centering
        ...
        edit_effect_button = tk.Button(window, text="Edit Effect", command=lambda: print("Edit Effect button clicked"))
        edit_effect_button.grid(row=0, column=2, sticky="ne", padx=10, pady=10)
